...
**Also load:** the project forms router `content/rules/forms.md` first for any managed-form task — it selects companions (`forms-add.md`, `form-module.md`, `async-methods.md`, …).
