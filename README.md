...
│   ├── commands/            # слэш-команды (doctor, deploy-and-test, economymode, litemode, evolve, getconfigfiles, loadfrom1cbase, update1cbase, checkmcp, installmcp, updatemcp, updaterules)
