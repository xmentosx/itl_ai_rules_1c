# Downstream patch ledger — `b4d9875b` / r10

The r8 baseline was rebuilt directly from upstream commit
`b4d9875b15c6d93f493035aee51f077126e72a21`; r10 is a minimal immutable hotfix
on the qualified r9 baseline. No earlier downstream branch was merged or rebased
onto the upstream intake. Each requirement remains classified as `keep`,
`drop`, or `rewrite` against this snapshot.

| ID | Decision | r10 treatment | Verification |
|---|---|---|---|
